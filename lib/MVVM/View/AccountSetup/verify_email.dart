          ...
          children: [
            Row(
              children: [
                ...
                SizedBox(width: 5.w,),
                Text('Email verification',style: TextStyles.profiletext,)
              ],
            ),
            SizedBox(height: 20.h,),
            Text('Code has been send to your email',style: TextStyles.regularwhite,),
            SizedBox(height: 5.h,),
            PinCodeTextField(
            ...
            Expanded(
              child: Align(
                ...
                child: ButtonWidget(text: 'Verify', onPressed: (){
