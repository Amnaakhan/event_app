            ...
            children: [
              ...
              Obx(() {
                return
                  ...
                  InkWell(
                    onTap: () {
                      eventController.updateEvent(eventTitle: titlecontroller.text,
                          startDate: sdateController.text, endDate: edateController.text,
                          startTime: _startTime, endTime: _endTime,
                          eventPrice: priceccontroller.text, id: '', description: desccontroller.text,
                        category: categoryccontroller.text, address: addessccontroller.text, city: cityccontroller.text,
                        latitude: '1234567', longitude: '12345678',  image: imageFile, );
                    },
                    child: Container(
                      height: 7.h,
                      width: double.infinity,
