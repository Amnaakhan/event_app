...
class _DonatePaymentPageState extends State<DonatePaymentPage> {
  ...
  void initState() {
    ...
    _controller = WebViewController()
      ...
      ..loadRequest(Uri.parse('https://eventgo-live.com/square-payment/3'));
  }
  ...
  Future<void> sendToBackend(String nonce) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://eventgo-live.com/api/v1/ads/6/donate'),
        headers: {
          'Accept': 'application/json',
          'Authorization': 'Bearer 75|dYvyKSzhmoxLpXH8ji2pkoPlp3usZ8NhJq57MWPMdac31f77',
